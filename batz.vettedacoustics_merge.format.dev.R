...
res1 <- batz.vettedacoustics_merge.format(dir.load = dir.load,
...
res2 <- batz.vettedacoustics_merge.format(dir.load = dir.load,
                                           load.pattern = "*FinalVetted.csv",
                                           dir.sub = FALSE,
                                           trim.noise = FALSE)
...
res4 <- batz.vettedacoustics_merge.format(dir.load = dir.load,
                                           load.pattern = "*FinalVetted.csv",
                                           dir.sub = FALSE,
...
res5 <- batz.vettedacoustics_merge.format(dir.load = "testdata",
...
res6 <- batz.vettedacoustics_merge.format(dir.load = "testdata",
                                           load.pattern = "*synth_vetted.csv",
                                           duplicates.remove = FALSE)
...
batz.vettedacoustics_merge.format(dir.load = "testdata", load.pattern = "*synth_vetted.csv",
                                   duplicates.remove = FALSE)
...
res8 <- batz.vettedacoustics_merge.format(dir.load = dir.load,
                                           load.pattern = "*FinalVetted.csv",
                                           log.file = TRUE)
